...
export default function ExportPage() {
  ...
  useEffect(() => {
    ...
    getThreadHistory(threadId).then((messages: ThreadMessage[]) => {
      // Find the latest message with an itinerary
    ...
    return (
      <main className="min-h-screen flex items-center justify-center bg-white px-4">
        <div className="text-center">
          <p className="text-sm text-muted-foreground mb-4">No itinerary found in this conversation.</p>
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 pb-12">
        <div className="mb-6 print-hidden">
          ...
          <p className="text-sm text-muted-foreground mt-1">Print-optimized itinerary view</p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-border text-center text-sm text-muted-foreground print-hidden">
          Click &quot;Print&quot; above or use Cmd/Ctrl+P to save as PDF
        </div>
      </div>
    </main>
  );
