...
VoyagerAI uses a single-agent orchestrator with three dedicated tool declarations, operating via a manual tool-execution loop (up to 10 iterations) for high-fidelity data structures:
