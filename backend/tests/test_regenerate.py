...
class TestRegenerateEndpoint:
    ...
    def test_regenerate_scopes_thread_id_per_user(self, client, monkeypatch):
        ...
        async def fake_regenerate(*, thread_id, user_id, locale, timezone, currency=None, cancel_event=None):
    ...
    def test_regenerate_error_yields_error_event(self, client, monkeypatch):
        ...
        async def failing_regenerate(*, thread_id, user_id, locale, timezone, currency=None, cancel_event=None):
