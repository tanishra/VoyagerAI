...
def _make_capturing_stream(captured: list):
    ...
    async def _stream(*, message, thread_id, user_id, locale=None, timezone=None, currency=None, cancel_event=None, attachments=None, client_message_id=None):
...
def client(monkeypatch):
    ...
    async def _fake_stream(*, message, thread_id, user_id, locale=None, timezone=None, currency=None, cancel_event=None, attachments=None, client_message_id=None):
        yield {"event": "thread_id", "data": {"thread_id": thread_id}}
        yield {"event": "done", "data": None}
